    ...
    >
      ...
      <div className=' flex flex-col items-center mx-auto  '>
        ...
        <ReactLink as={Link} to='/projects'>
          <p className='text-xl font-semibold rounded-md border-2 border-black p-4 mt-5 hover:bg-slate-400 dark:border-stone-100 dark:hover:bg-yellow-100/50 dark:hover:text-black'>
            See more projects
